...
class PlatformSprite(Sprite):
    def __init__(self,game,phtot_image,x,y,width,height):
...
class StickFigureSprite(Sprite):
    def __init__(self,game):
        ...
        self.images_right=game.canvas.create_image(200,470,image=self.images_left[0],anchor='nw')
        self.x=-2
        self.y=0
        ...
        game.canvas.bind_all('<KetPress-Left>',self.turn_left)
        game.canvas.bind_all('<KetPress-Right>', self.turn_right)
...
class DoorSprite(Sprite):
    def __init__(self,game,photo_image,x,y,width,height):
        ...
        self.photo_image=photo_image
        self.image=game.canvas.create_image(x,y,image=self.photo_image,anchor='nw')
        self.coordinates=Coords(x,y,x+(width/2),y+weight)
        self.endgame=True
g=Game()
